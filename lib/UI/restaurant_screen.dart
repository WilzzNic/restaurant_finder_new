...
import 'package:restaurant_finder_new/BLoC/restaurant_bloc.dart';
...
import 'package:restaurant_finder_new/UI/restaurant_tile.dart';
  ...
  Widget _buildStreamBuilder(RestaurantBloc bloc) {
    return StreamBuilder(
      ...
      builder:
        ...
        List<Restaurant> results = snapshot.data;
